...
#include "relaxationZone.H"             //add
#include "externalWaveForcing.H"        //add    
        ...
        while (pimple.loop())
        {
            if (pimple.firstIter() || moveMeshOuterCorrectors)
            {
                ...
                if (mesh.changing())
                {
                    ...
                    // gh = (g & mesh.C()) - ghRef;
                    // ghf = (g & mesh.Cf()) - ghRef;
                    gh = g & (mesh.C() - referencePoint);   // change by waveFoam
                    ghf = g & (mesh.Cf() - referencePoint);// change by waveFoam                    
